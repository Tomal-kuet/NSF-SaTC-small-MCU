...
systems, so the memory-corruption vulnerabilities above routinely lead to control-flow hijacking, unauthorized memory or peripheral access, and complete
software compromise. Modern embedded platforms increasingly provide hardware security mechanisms---including secure boot, memory

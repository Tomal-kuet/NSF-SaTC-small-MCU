...
Two ARM processor classes underlie most of this landscape: Cortex-M microcontrollers without a memory management unit, and Cortex-A application processors with one, increasingly used in automotive and edge-AI platforms; reconfigurable FPGA systems-on-chip combine both. This project targets exactly these architectures.
...
\noindent\textbf{Keywords:} hardware security; embedded systems; hardware/software co-design; remote execution verification; software least privilege.

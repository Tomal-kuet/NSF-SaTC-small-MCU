...
As preliminary work, we developed \enola~\cite{armanuzzaman2026enola}: unlike prior approaches evaluated on multi-core Cortex-A processors or requiring hardware modifications, \enola targets a single-core, off-the-shelf ARMv8.1-M Cortex-M85 MCU, demonstrating that scalable control-flow evidence can be generated on commodity, resource-constrained embedded processors.

...
This over-provisioning violates least privilege, enlarges the TCB, and increases the attack surface; in ARM TrustZone, for instance, all Secure-world software shares one protection domain and can read all Normal-world memory~\cite{cerdeira2022rezone,kuhne2024aster}.
